...
const Dashboard: React.FC = () => {
  ...
  const currentBets: Bet[] = [
    { id: 1, game: "India vs Australia", stake: 500, odds: 2.1, status: "Pending" },
    { id: 2, game: "MI vs CSK", stake: 800, odds: 1.8, status: "Pending" },
  ];

  const betHistory: Bet[] = [
    { id: 3, game: "Liverpool vs Real Madrid", stake: 1000, odds: 2.5, status: "Won" },
    { id: 4, game: "RR vs RCB", stake: 700, odds: 1.6, status: "Lost" },
  ];
...
//         {/* Header */}
//         <div className="flex justify-between items-center">
//           <h1 className="text-3xl font-bold text-green-500">🎰 BetOnIt Dashboard</h1>
//           <button
//             onClick={onLogout}
//             className="flex items-center gap-2 bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md font-semibold"
//           >
...
//         {/* Deposit / Withdraw */}
//         <div className="flex gap-4">
//           <button className="bg-green-600 hover:bg-green-700 px-6 py-2 rounded-lg font-bold shadow-md">
//             Deposit
//           </button>
//           <button className="bg-yellow-500 hover:bg-yellow-600 px-6 py-2 rounded-lg font-bold shadow-md">
//             Withdraw
//           </button>
//         </div>
...
//         {/* Current Active Bets */}
//         <div>
//           <h2 className="text-2xl font-bold mb-4 text-green-400">📈 Current Bets</h2>
//           <div className="space-y-3">
//             {currentBets.length === 0 ? (
//               <p className="text-gray-400">No active bets.</p>
//             ) : (
...
//         {/* Bet History */}
//         <div>
//           <h2 className="text-2xl font-bold mb-4 text-green-400">🕘 Bet History</h2>
//           <div className="space-y-3">
//             {betHistory.length === 0 ? (
//               <p className="text-gray-400">No previous bets.</p>
//             ) : (
